...
function showWeatherNow(date, temp, desc, weather, wind, humidity, city, timestamp) {
    ...
    if (desc.toLowerCase().trim() === 'few clouds' || desc.toLowerCase().trim() === 'scattered clouds') {
        icon = "https://github.com/M-Stephan/2.PROJECTS-3.Weather-app/public/cloudy.png"; //Partiellement ensoleillé
    } else if (desc.toLowerCase().trim() === 'broken clouds' || desc.toLowerCase().trim() === 'overcast clouds') {
        icon = "https://github.com/M-Stephan/2.PROJECTS-3.Weather-app/public/clouds.png"; // Nuageux 
    } else if (weather.toLowerCase().trim() === 'snow') {
        icon = "https://github.com/M-Stephan/2.PROJECTS-3.Weather-app/public/snow.png"; // Neige
    } else if (weather.toLowerCase().trim() === 'rain') {
        icon = "https://github.com/M-Stephan/2.PROJECTS-3.Weather-app/public/rainy.png"; // Pluie
    } else if (weather.toLowerCase().trim() === 'thunderstorm') {
        icon = "https://github.com/M-Stephan/2.PROJECTS-3.Weather-app/public/thunder.png"; // Orage
    } else {
        icon = "https://github.com/M-Stephan/2.PROJECTS-3.Weather-app/public/sunny.png"; // ensoleillé par defaut
    };
